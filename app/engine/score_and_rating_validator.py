from app.engine.calculator import filter_played_games, calculate_rating_average
from app.engine.models import Game
from app.engine.tables import MIN_AVERAGE_RATING_TABLE
...
def validate_minimum_average_rating(games: list[Game], target_title: str) -> bool:
    """Validate 1.4.8a: The minimum average ratings Ra of the opponents.
